...
def main():
    ...
    embedding_option = st.sidebar.radio(
        "Choose Embeddings", ["OpenAI Embeddings", "HuggingFace Embeddings(very slower)"])

    retriever_type = st.sidebar.selectbox(
        "Choose Retriever", ["Similarity Search", "Support Vector Machines(not completed yet)"])
